...
public class TradeRequest extends Request {
    public TradeRequest(String token, Tribe tribe, Class<? extends Resource> give, Class<? extends Resource> receive, int amount) {
        super("trade", "TradeRequest", token, createBody(tribe, give, receive, amount));
    }
