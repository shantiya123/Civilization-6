...
public class TradeSystem {
     ...
     * Invalid actions are surfaced through NotificationRequestedEvent, same as every other
     * system, so controllers never need to catch gameplay exceptions themselves.
     */
