...
- src/Animation/BoardAnimations.java
...
- src/Game/Systems/AnimationSystem.java
...
# File: src/Animation/Animation.java
...
# File: src/Animation/BoardAnimations.java
...
public class BoardAnimations extends BaseAnimation {
    ...
    public BoardAnimations(Hex hex, HexManager hexManager) {
...
public class SystemManager {
    ...
    public SystemManager(World world) {
        this.world = world;
        this.drawingSystem = new DrawingSystem(world);
...
# File: src/Game/Systems/AnimationSystem.java
